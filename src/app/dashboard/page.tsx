...
// Componente para cada tarjeta del dashboard
  ...
  return (
    <div className="space-y-8">
      ...
      <section className="bg-white p-6 rounded-lg shadow border border-gray-200">
        <h2 className="text-xl font-semibold text-gray-900">Completa tu perfil</h2> {/* Ajuste de tamaño y peso */}
      ...
      <section className="bg-white p-6 rounded-lg shadow border border-gray-200">
        <h2 className="text-xl font-semibold text-gray-900">Panel de Control</h2> {/* Ajuste de tamaño y peso */}
        <p className="text-gray-600 mt-2">
